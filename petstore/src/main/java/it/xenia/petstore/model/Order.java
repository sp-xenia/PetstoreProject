...
public class Order implements Serializable{
	...
	public enum StatusEnum {
		...
		public static Map<String, Integer> initInventory(){
			Map<String, Integer> inventory = new HashMap<>();
//			inventory.put("PLACED",0);
//			inventory.put("APPROVED",0);
//			inventory.put("DELIVERED",0);
			for (StatusEnum status : values()) {
				inventory.put(status.name(), 0);
			}
			return inventory;
		}
	}
...
//	}
	...
	public boolean equals(java.lang.Object o) {
		...
		Order order = (Order) o;
		return Objects.equals(this.id, order.id) && Objects.equals(this.petId, order.petId)
